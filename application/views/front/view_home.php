            ...
            <div id="presentation" class="container nav-scroll scrollspy">
                <div class="row">
                    ...
                    <div class="col m5 s12 offset-m1">
                        ...
                        <div>
                            <p>Suite à l'obtention de mon Baccalauréat en 2016, j'ai commencé à m'intéresser au développement web et j'ai vite saisi que c'était ma voie.<br>
                        ...
                        <div class="col s12">
                            ...
                            <div class="center">
                                <div class="row">
                                    <div class="col m3 s6">
                                        <p>CodeIgniter</p>
                                        <img class="ci" src="<?php echo base_url(); ?>assets/img/skill/codeigniter_logo.png" alt="CodeIgniter" style="width:43%"/>
                                    </div>
                                    <div class="col m3 s6">
                                        <p>WordPress</p>
